...
class LunarLanderTerrainHeightEnv(gym.Env, EzPickle):
    metadata = {
    ...
    def __init__(self):
        ...
        self.chunk_pos_y = [0 for i in range(CHUNKS)]
    ...
    def reset(self):
        ...
        for i in range(CHUNKS-1):
            ...
            self.chunk_pos_y[i+1] = smooth_y[i+1]
    ...
    def step(self, action):
        ...
        height = 0
        try:
            CHUNKS = len(self.chunk_pos_y)-1
            W = VIEWPORT_W/SCALE
            CHUNK_W = W / CHUNKS
            
            num_chunk = int(pos[0]//CHUNK_W)
            m = (self.chunk_pos_y[num_chunk] - self.chunk_pos_y[num_chunk+1]) / CHUNK_W
            b = self.chunk_pos_y[num_chunk] - m*(num_chunk*CHUNK_W)
            
            chunk_h = m*pos[0] + b
            height = pos[1] - chunk_h
        except:
            height = 0
